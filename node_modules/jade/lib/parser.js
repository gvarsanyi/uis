...
Parser.prototype = {
  ...
  parseInclude: function(){
    ...
    // NOTE: patched by gvarsanyi for uis
    var p = require('path');
    var _file = p.resolve(this.filename),
        _path = p.resolve(path);
    if (!exports.__includes) {
      exports.__includes = {};
    }
    if (!exports.__includes[_file]) {
      exports.__includes[_file] = {};
    }
    exports.__includes[_file][_path] = true;
    // NOTE: end of patch
