...
(function() {
  var Outblock, colors, config, enter, esc, escaped_out, first, head_shown, heads, hourglass, ngroup, outblock, plural, print_block, shown, stats, types;
  ...
  print_block = function(push_x, push_y, title, inf, prev_inf) {
    var color, n, working, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
    ...
    if ((_ref = inf.error) != null ? _ref.length : void 0) {
      ...
      if (inf.status) {
        if (title === 'test') {
          ...
          if (((_ref1 = inf.size) != null ? (_ref2 = _ref1.all) != null ? _ref2.statements : void 0 : void 0) != null) {
            color = colors.white;
            if (inf.size.all.statements < (((_ref3 = config.test) != null ? (_ref4 = _ref3.coverage) != null ? _ref4.bar : void 0 : void 0) || 80)) {
              color = colors.warn;
            }
            outblock.color(color).write(inf.size.all.statements + '%').color(colors.faint).write(' of statements');
          }
        } else {
          n = ngroup(inf.status - (((_ref5 = inf.warning) != null ? _ref5.length : void 0) || 0));
          outblock.color(colors.white).write(n);
          if ((_ref6 = inf.warning) != null ? _ref6.length : void 0) {
