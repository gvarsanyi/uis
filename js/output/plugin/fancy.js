...
(function() {
  var Outblock, esc, escaped_out, first, head_shown, heads, hourglass, ngroup, outblock, print_block, shown, stats, types;
  ...
  escaped_out = function(msg) {
    return process.stdout.write(String(msg).split(esc).join('\\0').substr(0, process.stdout.columns - 1) + '\r');
  };
