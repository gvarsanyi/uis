...
(function() {
  var Service, app, bayeux, config, deploy_event, deploy_promise_pending, deploy_release, deployed, express, faye, fs, messenger, once_deployed, patch, path, repo_name, restify, server, stats, _i, _len, _ref,
  ...
  once_deployed = function(callback) {
    if (deployed >= 3) {
      return callback();
    }
    return deploy_promise_pending.push(callback);
  };

  deploy_event = function(msg) {
    var _ref, _ref1;
  ...
  deploy_release = function() {
    ...
    if (deployed === 3) {
      ...
      while (deploy_promise_pending.length) {
        _results.push(deploy_promise_pending.shift()());
      }
      return _results;
    }
  };
  ...
  Service = (function() {
    ...
    function Service() {
      ...
      var contents, deploy, patch_js, proxy, _fn, _j, _len1, _ref1, _ref2, _ref3;
      app.use(function(req, res, next) {
        return once_deployed(next);
      });
    ...
    Service.prototype.incoming = function(msg) {
      ...
      for (_j = 0, _len1 = msgs.length; _j < _len1; _j++) {
        ...
        _results.push(deploy_event(msg));
      }
      return _results;
    };
