...
(function() {
  var Task, WatchedFile, fs, gaze, md5, messenger, path,
  ...
  WatchedFile = (function() {
    function WatchedFile(compiler, path) {
  ...
  Task = (function() {
    ...
    Task.prototype.watch = function(watchables, source, callback) {
      var err, gaze_error, k, updated, watchable, _i, _len;
      if (watchables == null) {
        watchables = [];
      }
      ...
      try {
        ...
        for (_i = 0, _len = watchables.length; _i < _len; _i++) {
          ...
          this._watched[watchable] = new WatchedFile(this, watchable);
        }
