...
(function() {
  var HUD, Stats, bayeux, colors, create, cue_processor, hud, init, message_cue, orig_error, orig_log, process_msg, ready_list, reconnect, reload, reload_css, reload_i, reloading, remove, service_up, state_symbols, stats, stringify, style, subscription, symbols,
  ...
  HUD = (function() {
    ...
    HUD.prototype.render = function() {
      ...
      if (!this.div) {
        this.panel = create(document.body, {
          bottom: '5px',
          position: 'fixed',
          right: '5px',
        ...
        this.msgs = create(this.panel);
        this.info = create(this.panel);
