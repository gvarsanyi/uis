...
(function() {
  var HUD, HUD2, Stats, add, bayeux, colors, create, cue_processor, hud, hud2, init, message_cue, msg_div, msgs, orig_error, orig_log, process_msg, ready_list, reattach, reconnect, reload, reload_css, reload_i, reloading, remove, service_up, show, show_id, state_symbols, stats, stringify, style, subscription, symbols,
  ...
  HUD2 = (function() {
    ...
    HUD2.prototype.render = function() {
      var anim, state;
      if (!ready) {
        return pending = true;
      }
      if (!this.div) {
        this.div = create(document.body, {
  ...
  HUD = (function() {
    ...
    HUD.prototype.render = function() {
      var add_info, hidden_issues, info, issue, issue_cue, pt, repo, shown_issues, stat, task, tasks, touched, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _results;
      if (!ready) {
        return pending = true;
      }
      if (!reattach(div)) {
